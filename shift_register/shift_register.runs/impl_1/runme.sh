...
HD_PWD='E:/Codes/verilog-vivado/shift_register/shift_register.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log universal_shift_register.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source universal_shift_register.tcl -notrace
