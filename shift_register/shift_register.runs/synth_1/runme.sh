...
HD_PWD='E:/Codes/verilog-vivado/shift_register/shift_register.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log universal_shift_register.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source universal_shift_register.tcl
