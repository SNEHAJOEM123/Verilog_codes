...
HD_PWD='E:/Codes/verilog-vivado/sipo_shift_register/sipo_shift_register.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sipo_shift_register.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sipo_shift_register.tcl
