...
HD_PWD='E:/Codes/verilog-vivado/sipo_shift_register/sipo_shift_register.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sipo_shift_register.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sipo_shift_register.tcl -notrace
