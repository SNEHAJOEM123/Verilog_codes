...
HD_PWD='E:/Codes/verilog-vivado/decoder_2_to_4_dataflow/decoder_2_to_4_dataflow.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_2_to_4_dataflow.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoder_2_to_4_dataflow.tcl
