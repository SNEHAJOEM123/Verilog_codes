...
HD_PWD='E:/Codes/verilog-vivado/decoder_2_to_4_dataflow/decoder_2_to_4_dataflow.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_2_to_4_dataflow.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decoder_2_to_4_dataflow.tcl -notrace
