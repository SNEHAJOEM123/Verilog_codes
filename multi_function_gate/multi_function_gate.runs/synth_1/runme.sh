...
HD_PWD='E:/Codes/verilog-vivado/multi_function_gate/multi_function_gate.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_function_gate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multi_function_gate.tcl
