...
HD_PWD='E:/Codes/verilog-vivado/multi_function_gate/multi_function_gate.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_function_gate.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multi_function_gate.tcl -notrace
