...
HD_PWD='E:/Codes/verilog-vivado/ripple_carry_adder_4/ripple_carry_adder_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ripple_carry_adder_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ripple_carry_adder_4.tcl
