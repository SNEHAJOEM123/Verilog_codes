...
HD_PWD='E:/Codes/verilog-vivado/ripple_carry_adder_4/ripple_carry_adder_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ripple_carry_adder_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ripple_carry_adder_4.tcl -notrace
