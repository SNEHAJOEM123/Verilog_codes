...
HD_PWD='E:/Codes/verilog-vivado/Up_down_decade_counter/Up_down_decade_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log up_down_4_decade_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source up_down_4_decade_counter.tcl -notrace
