...
HD_PWD='E:/Codes/verilog-vivado/Up_down_decade_counter/Up_down_decade_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log up_down_4_decade_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source up_down_4_decade_counter.tcl
