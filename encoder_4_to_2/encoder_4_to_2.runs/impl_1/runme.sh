...
HD_PWD='E:/Codes/verilog-vivado/encoder_4_to_2/encoder_4_to_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder_4_to_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source encoder_4_to_2.tcl -notrace
