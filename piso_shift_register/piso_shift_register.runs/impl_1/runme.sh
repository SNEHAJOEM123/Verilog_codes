...
HD_PWD='E:/Codes/verilog-vivado/piso_shift_register/piso_shift_register.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log piso_shift_register.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source piso_shift_register.tcl -notrace
