...
HD_PWD='E:/Codes/verilog-vivado/piso_shift_register/piso_shift_register.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log piso_shift_register.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source piso_shift_register.tcl
