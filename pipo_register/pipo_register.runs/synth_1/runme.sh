...
HD_PWD='E:/Codes/verilog-vivado/pipo_register/pipo_register.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pipo_shift_register.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pipo_shift_register.tcl
