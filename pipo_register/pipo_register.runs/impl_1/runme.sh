...
HD_PWD='E:/Codes/verilog-vivado/pipo_register/pipo_register.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pipo_shift_register.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pipo_shift_register.tcl -notrace
