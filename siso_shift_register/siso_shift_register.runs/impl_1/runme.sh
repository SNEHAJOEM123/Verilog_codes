...
HD_PWD='E:/Codes/verilog-vivado/siso_shift_register/siso_shift_register.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log siso_shift_register.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source siso_shift_register.tcl -notrace
