...
HD_PWD='E:/Codes/verilog-vivado/siso_shift_register/siso_shift_register.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log siso_shift_register.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source siso_shift_register.tcl
