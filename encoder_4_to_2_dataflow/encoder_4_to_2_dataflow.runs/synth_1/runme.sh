...
HD_PWD='E:/Codes/verilog-vivado/encoder_4_to_2_dataflow/encoder_4_to_2_dataflow.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder_4_to_2_dataflow.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source encoder_4_to_2_dataflow.tcl
