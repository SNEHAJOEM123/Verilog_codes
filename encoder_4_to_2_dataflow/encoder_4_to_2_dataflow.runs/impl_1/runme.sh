...
HD_PWD='E:/Codes/verilog-vivado/encoder_4_to_2_dataflow/encoder_4_to_2_dataflow.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder_4_to_2_dataflow.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source encoder_4_to_2_dataflow.tcl -notrace
